...
public class AES {
	...
	public static String encode(String encodeRules, String content) throws Exception {
		...
		// 10.将加密后的数据转换为字符串
		return Base64.getUrlEncoder().encodeToString(byte_AES);
	 ...
	 */
	public static String dncode(String encodeRules, String content) throws Exception {
		// 1.构造密钥生成器，指定为AES算法,不区分大小写
		KeyGenerator keygen = KeyGenerator.getInstance("AES");
		// 2.根据ecnodeRules规则初始化密钥生成器
		// 生成一个128位的随机源,根据传入的字节数组
	...
	public static void main(String[] args) throws Exception {
		String aa = "abc012ABC中华人民";
		String encodeRules = "asdfsadf1232131";
		String mw = encode(encodeRules, aa);
		System.out.println(mw);
		String bb = dncode(encodeRules, mw);
